...
import ReturnPage from '../PrivacyPage/ReturnPage';
import CancellationPage from '../PrivacyPage/CancellationPage';
import ShippingPage from '../PrivacyPage/ShippingPage';
    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route path="services-single/:slug" element={<ServiceSinglePage />} />
