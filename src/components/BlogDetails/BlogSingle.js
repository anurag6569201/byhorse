                        ...
                        <div className="wpo-blog-content">
                            <div className="post format-standard-image">
                                ...
                                <div className="entry-meta">
                                    <ul>
                                        <li><i className="fi flaticon-calendar"></i><Link onClick={ClickHandler} to="#">02 Apr 2024</Link>
                                        </li>
                                    ...
                                    <div className="col-lg-6 col-12">
                                        <div className="tag-share clearfix">
                                            <div className="tag">
                                                <span>Tag: </span>
                                                <ul>
                                                    <li><Link onClick={ClickHandler} to="#">Business</Link></li>
                                                    <li><Link onClick={ClickHandler} to="#">Design</Link></li>
                                                    <li><Link onClick={ClickHandler} to="#">apps</Link></li>
                                                    <li><Link onClick={ClickHandler} to="#">data</Link></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div className="comment-wrapper">
                                                        ...
                                                        <div className="comment-area">
                                                            ...
                                                            <div className="comments-reply">
                                                                <Link onClick={ClickHandler} className="comment-reply-link" to="#"><i
