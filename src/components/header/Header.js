...
const Header = (props) => {
    ...
    return (
        <header id="header" style={{backgroundColor:'#0F1525'}}>
            <div className={"" + props.hclass} style={{backgroundColor:'#0F1525'}}>
                <nav className=" navbar navbar-expand-lg navbar-light" style={{backgroundColor:'#0F1525'}}>
                    <div className="container-fluid" style={{backgroundColor:'#0F1525'}}>
                        <div className="row align-items-center">
                                ...
                                <div id="navbar" className="collapse navbar-collapse navigation-holder">
                                    ...
                                    <ul className="nav navbar-nav mb-2 mb-lg-0">
                                        ...
                                        {/* <Link onClick={ClickHandler} to="/blog">Blog</Link> */}
                                            ...
                                            {/* <Link onClick={ClickHandler} to="/blog-single/Why-Industry-Are-A-Juicy-Target-For-Cyberattack">Blog</Link> */}
                                            {/* <ul className="sub-menu">
                            ...
                            <div className="col-lg-3 col-md-2 col-2">
                                <div className="header-right">
                                    ...
                                    {/* <a href="tel:+881900678956" className="call">
                                        <div className="icon">
                                            <img src={Call} alt="" />
                                        </div>
                                        <div className="text">
                                    ...
                                    <div className="close-form">
                                        ...
                                        <Link onClick={ClickHandler} className="theme-btn" to="/contact">Contact Us <i
                                            className="flaticon-next"></i></Link>
                                    </div>
                                </div>
                            </div>
